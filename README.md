...
from open satellite and weather data. The site rebuilds itself every
15 minutes, and the model is regenerated every 6 hours and archived so
anyone can check, after the fact, how well it did against the official
...
optional/        self-hosting and phase-2/3 extras
```
